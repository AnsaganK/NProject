...
api_router.include_router(cars.router, tags=["Транспорт организаций"], prefix="/cars")
...
api_router.include_router(mini_status.router, tags=["МиниСтатусы"],
                          prefix="/mini_statuses")  # dependencies=[Depends(JWTBearer())])
